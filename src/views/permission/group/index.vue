  ...
  <div class="app-container">
    <el-row>
      <el-form :inline="true" :model="selectInfo">
        <div v-if="$store.getters.buttons.contains('/permission/group/index/select')" style="display: inline">
    ...
    <el-row>
      <el-table v-loading="listLoading" :data="groupList" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column align="center" label="操作" width="300"
                         ...
                         || $store.getters.buttons.contains('/permission/group/index/delete') ">
          <template slot-scope="scope">
            <el-button
              type="warning"
              size="small"
            ...
            <el-button
              ...
              v-if="$store.getters.buttons.contains('/permission/group/index/delete')"
            >
              删除
            </el-button>
          </template>
